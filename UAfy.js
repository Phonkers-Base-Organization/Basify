...
class SettingsMenu {
  ...
  static InfoSection({ locale }) {
    ...
    const phonkersbaseLogoSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="122" height="26" viewBox="0 0 122 26" fill="none">
    ...
    <path fill-rule="evenodd" clip-rule="evenodd" d="M15.2319 8.98484V21.04C18.1604 20.676 22.6659 21.5859 22.6659 17.2187C22.6959 16.2482 22.3685 14.2891 20.8187 14.2163C22.0441 13.9616 22.2304 12.2905 22.1703 11.4868C22.0802 9.57622 20.8187 8.166 15.2319 8.98484ZM17.8901 13.6249V10.2586C18.7011 10.2586 19.7374 9.80368 19.7374 11.8963C19.7374 13.7159 18.656 13.6249 17.8901 13.6249ZM17.8901 19.3568V15.2171C18.8813 14.9897 20.1879 14.8987 20.1879 17.3097C20.1879 19.5297 18.7462 19.3568 17.8901 19.3568Z" fill="white"/>

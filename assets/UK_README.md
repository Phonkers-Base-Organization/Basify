...
Після оновлення Spotify оновіть або повторно застосуйте Spicetify як рекомендовано в [офіційних відповідях Spicetify](https://spicetify.app/docs/faq.html):

```bash
spicetify backup apply
```

Якщо сам Spicetify застарів, скористайтеся [офіційною інструкцією зі встановлення Spicetify](https://spicetify.app/docs/getting-started.html), щоб оновити або перевстановити його для вашої операційної системи.
